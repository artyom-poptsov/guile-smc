...
;;;     #<procedure char:solidus? (ctx ch2)>
...
(define %transition-table
  `(((name . read_title)
    ...
    ((name . check_top_multiline_comment_begin)
     (description
       .
       "Check for a single quote symbol that marks  the start of a multi-line comment at the  beginning of the PlantUML data.")
     (event-source unquote char-context-event-source)
     (transitions
       (,char:eof-object?
        ,throw-unexpected-end-of-file-error
    ...
    ((name . check_multiline_comment_begin)
     (description
       .
       "Check for a single quote symbol that marks  the start of a multiline comment.")
     (event-source unquote char-context-event-source)
     (transitions
       (,char:eof-object?
        ,throw-unexpected-end-of-file-error
    ...
    ((name . skip_hide_block)
     (description
       .
       "Skip the \"hide\" block in a state diagram.")
     (event-source unquote char-context-event-source)
     (transitions
       (,char:eof-object?
        ,throw-unexpected-end-of-file-error
    ...
    ((name . check_top_multiline_comment_end)
     (description
       .
       "Check if the current multiline comment ends.")
     (event-source unquote char-context-event-source)
     (transitions
       (,char:eof-object?
        ,throw-unexpected-end-of-file-error
    ...
    ((name . read_state_description)
     (description
       .
       "Read a state description if it is present.  If a state  has several description lines, they are joined together  into a single state description string.")
     (event-source unquote char-context-event-source)
     (transitions
       (,char:eof-object? ,action:no-op #f)
    ...
    ((name . search_start_tag)
     (description
       .
       "Search for the the \"@\" symbol that marks the start of the  \"@plantuml\" tag.")
     (event-source unquote char-context-event-source)
     (transitions
       (,char:eof-object?
        ,throw-unexpected-end-of-file-error
...
(define-method
  ...
  (fsm-current-state-set!
    self
    (fsm-state self 'search_start_tag)))
